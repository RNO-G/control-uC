...
LORAWAN_OBJS+=$(addprefix $(BUILD_DIR)/lorawan/board/, rtc-board.o delay-board.o gpio-board.o sx1272-board.o utilities.o spi-board.o board.o )
LORAWAN_OBJS+=$(BUILD_DIR)/lorawan/radio/sx1272/sx1272.o 
LORAWAN_OBJS+=$(BUILD_DIR)/lorawan/lorawan.o 
...
LORAWAN_OBJS+=$(addprefix $(BUILD_DIR)/lorawan/peripherals/soft-se/, soft-se.o aes.o cmac.o )
